export default {
    ...
    inputCallbackName: document.querySelector('#callbackName'),
    inputCallbackPhone: document.querySelector('#callbackPhone'),
    inputCallbackMsg: document.querySelector('#callbackMsg'),
    callbackSubmitBtn: document.querySelector('.main-overlay__modal-submit'),
};
